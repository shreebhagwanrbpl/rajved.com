...
export async function fetchHomeData() {
    return fetchDocCached("websites/rajvedcom/pages/home");
}

export async function fetchContactData() {
    return fetchDocCached("websites/rajvedcom/pages/contact");
}

export async function fetchServicesData() {
    return fetchDocCached("websites/rajvedcom/pages/services");
}

export async function fetchDistrictData(district) {
    if (!district) return null;
    return fetchDocCached(`websites/rajvedcom/districts/${district}`);
}
...
export function subscribeToCatalog(onUpdate) {
    ...
    try {
        const legacyUnsub = onSnapshot(
            doc(db, "websites", "rajvedcom", "pages", "products"),
            (docSnap) => {
                if (docSnap.exists()) {
